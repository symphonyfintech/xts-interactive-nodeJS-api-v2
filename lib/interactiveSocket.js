...
module.exports = class XTSEmitter {
    ...
    init(reqObject) {
        ...
        this.socketMD.socketMarketData = socketIoClient(this.url, { path: "/interactive/socket.io", reconnection: false, query: { token: this.token, userID: this.userID,apiType: "INTERACTIVE" } });
