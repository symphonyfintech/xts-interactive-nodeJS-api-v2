...
module.exports = class XTSInteractive {
    ...
    async logIn(reqObject) {
        ...
        try {
            ...
            this.appVersion = sponse.result.appVersion;
    ...
    async getOrderBook(reqObject) {
        ...
        try {
            await this.checkLoggedIn();
            let response = null;
            if (reqObject.appOrderID)
                // to get order history 
                response = await request.processRequest("GET", this.url + settings.restApi.orders+ "?appOrderID=" + reqObject.appOrderID, { 'authorization': this.token }, null);
            else
                // to get order book
                response = await request.processRequest("GET", this.url + settings.restApi.orders + "?clientID=" + clientID, { 'authorization': this.token }, null);
            return response;
    ...
    async getEnums(reqObject) {
        ...
        try {
            let response = null;
            if (reqObject == null)
                response = await request.processRequest("GET", this.url + settings.restApi.enums, { 'authorization': this.token }, null);
            return response;
    ...
    async exchangeMessage(reqObject) {
        ...
        try {
            let response = null;
            if (reqObject == null)
                response = await request.processRequest("GET", this.url + settings.restApi.message + "?exchangeSegment=" + reqObject.exchangeSegment, { 'authorization': this.token }, null);
            return response;
    ...
    async exchangeStatus(reqObject) {
        ...
        try {
            let response = null;
            if (reqObject == null)
                response = await request.processRequest("GET", this.url + settings.restApi.status + "?userID=" + reqObject.userID, { 'authorization': this.token }, null);
            return response;
